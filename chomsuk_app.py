...
- Style Tag ต้องระบุ "instrumental, no vocals" ชัดเจน

สร้างให้ครบชุด โดยขึ้นต้นด้วยวิธีใช้แบบนี้เป๊ะๆ:

━━━ ⚠️ วิธีใช้กับ Suno (สำคัญมาก!) ━━━
1. เปิดสวิตช์ "Instrumental" ใน Suno ให้เป็น ON (ช่อง Lyrics จะหายไป)
2. copy เฉพาะ Style prompt ด้านล่าง → วางในช่อง Style of Music
3. copy ชื่อเพลง → วางในช่อง Title
4. ❌ ห้ามวางเรื่องราว/โครงสร้างลงช่อง Lyrics เด็ดขาด — Suno จะร้องตามตัวอักษร!
(ส่วนเรื่องราวกับคำอธิบาย เอาไว้ใช้ตอนโพสต์ YouTube/Spotify เท่านั้น)

━━━ ชื่อเพลง (ไทย + English) ━━━

━━━ SUNO STYLE PROMPT (วางในช่อง Style เท่านั้น) ━━━
Style prompt:
BPM:
Key:

━━━ เรื่องราวของเพลง (ไว้โพสต์ ไม่ใช่วางใน Suno) ━━━
(2-3 ประโยค — ความรู้สึก ภาพ บรรยากาศที่เพลงนี้เล่า)

━━━ คำอธิบาย YouTube / Spotify (ไว้โพสต์ ไม่ใช่วางใน Suno) ━━━
...
- ถ้าเสียงเป็น Duet ให้ระบุ [ชาย] / [หญิง] หน้าแต่ละบรรทัดที่ร้อง และมี [Together] ตอน Chorus
- ถ้าเป็นวง ให้ระบุ [All] หรือแบ่ง Part ชัดเจน
- Suno Style Tag ต้องใส่ voice type ด้วย (male vocal / female vocal / duet / choir)
